...
function loadData() {
    ...
    totalActivities = Number(localStorage.getItem('totalActivities')) || 0;
...
function updateDashboard() {
    ...
    document.getElementById('totalEmission').textContent = totalEmission.toFixed(1) + ' kg';

    document.getElementById('transportEmission').textContent = transportEmission.toFixed(1) + ' kg';

    document.getElementById('energyEmission').textContent = energyEmission.toFixed(1) + ' kg';

    document.getElementById('foodEmission').textContent = foodEmission.toFixed(1) + ' kg';

    document.getElementById('shoppingEmission').textContent = shoppingEmission.toFixed(1) + ' kg';

    document.getElementById('digitalEmission').textContent = digitalEmission.toFixed(1) + ' kg';

    document.getElementById('goalDisplay').textContent = monthlyGoal + ' kg';
...
function updateProfile() {
    ...
    document.getElementById('xpLabel').textContent = xpInLevel + ' / 10 activities to next level';
    ...
    if (activityLog.length === 0) {
        ...
        container.innerHTML = `
            <div class="empty-state">
                ...
                <p>Log activities to see your top emitters</p>
            </div>`;
...
// ── ADD EMISSION ───────────────────────────────────────────────────────────
function addEmission(category, amount, label) {
